...
const isAllMarkRead = computed(() => props.notifications.some(item => item.isRead === false))
...
<template>
  <IconBtn id="notification-btn">
    ...
    >
      <VCard class="d-flex flex-column border">
        <!-- 👉 Header -->
          ...
          <template #append>
            ...
            >
              ...
              <VTooltip
                ...
                location="start"
              >
                {{ !isAllMarkRead ? 'Tout marqué comme non lu' : 'Tout marqué comme lu' }}
              </VTooltip>
            </IconBtn>
          </template>
        </VCardItem>
          ...
          <VList class="notification-list rounded-0 py-0">
            ...
            >
              ...
              <VListItem
                ...
                @click.prevent="$emit('click:notification', notification)"
              >
                <!-- Slot: Prepend -->
                ...
                <VListItemSubtitle>{{ notification.title }}</VListItemSubtitle>
                <span class="text-xs text-disabled">{{ getTimeAgo(notification.createdAt) }}</span>
            ...
            >
              <VListItemTitle>Aucune notification trouvée</VListItemTitle>
            </VListItem>
          </VList>
        </PerfectScrollbar>
        ...
        >
          <VBtn block> Voir toutes les notifications </VBtn>
        </VCardActions>
      </VCard>
    </VMenu>
  </IconBtn>
