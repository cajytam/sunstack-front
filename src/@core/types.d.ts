...
export interface PricingFactorType {
  name: string | null
}

export interface PricingFactorPrice {
  pricingFactor: string
  markedPrice: number
  unmarkedPrice: number
  startAt: Date
  endAt?: Date
  addedBy?: string
  addedAt?: Date
...
export interface PricingFactorCondition {
  pricingFactorPrice: number
  type: string
  value: string
}
