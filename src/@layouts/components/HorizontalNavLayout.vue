...
<template>
  ...
  >
    ...
    >
      ...
      <!-- 👉 Navigation -->
      <div class="layout-horizontal-nav layout-horizontal-nav-border">
...
.layout-horizontal-nav-border {
  border-block-end: 1px solid rgba(var(--v-border-color), var(--v-border-opacity));
  box-shadow: 0 1.2rem 1.2rem -1.2rem rgba(var(--v-theme-on-background), 0.2);
}
